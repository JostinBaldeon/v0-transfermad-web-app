-- Insert news data
INSERT INTO news (slug, title, excerpt, content, image, category, published_at, author, related_news)
VALUES
(
  'premios-temporada-35',
  'Premios de la Temporada 35: Los mejores del año',
  'Descubre quiénes fueron los jugadores más destacados de esta temporada en todas las categorías.',
  '
...
Felicitamos a todos los premiados y esperamos que la Temporada 36 nos traiga aún más emociones y grandes momentos de fútbol.
  ...
  '/news/premios-35.jpg',
  'premios',
  '2024-06-15'::TIMESTAMP WITH TIME ZONE,
  'Redacción TransferMad',
  ARRAY['premios-temporada-34', 'records-goleadores-35']
),
(
  'actualizacion-1-3',
  'Actualización 1.3: Nuevas funciones y mejoras',
  'La nueva actualización trae importantes mejoras en el sistema de valoraciones y nuevas características.',
  '
...
Agradecemos a toda la comunidad por sus sugerencias y reportes que hacen de TransferMad una mejor plataforma cada día.
  ',
  '/news/actualizacion-1-3.jpg',
  'actualizacion',
  '2024-06-10'::TIMESTAMP WITH TIME ZONE,
  'Equipo Técnico',
  ARRAY['actualizacion-1-2']
),
(
  'premios-temporada-34',
  'Premios de la Temporada 34: Resumen completo',
  'Un repaso a los mejores jugadores de la temporada 34 y sus increíbles logros.',
  '
...
Una temporada para el recuerdo que estableció nuevos récords en la historia de la Mad League.
  ...
  '/news/premios-34.jpg',
  'premios',
  '2024-01-20'::TIMESTAMP WITH TIME ZONE,
  'Redacción TransferMad',
  ARRAY['premios-temporada-35', 'descarga-archivos-34']
),
(
  'actualizacion-1-2',
  'Actualización 1.2: Hall de la Fama y Haaland',
  'Nueva sección de Hall de la Fama y múltiples mejoras en la experiencia de usuario.',
  '
...
Continuamos trabajando para hacer de TransferMad la mejor plataforma para seguir la Mad League.
  ',
  '/news/actualizacion-1-2.jpg',
  'actualizacion',
  '2023-11-05'::TIMESTAMP WITH TIME ZONE,
  'Equipo Técnico',
  ARRAY['actualizacion-1-3']
),
(
  'descarga-archivos-34',
  'Descarga de archivos de la Temporada 34',
  'Ya están disponibles todos los archivos y estadísticas de la temporada 34 para descargar.',
  '
...
Recuerda que estos archivos son de uso exclusivo para la comunidad de la Mad League.
  ',
  '/news/descarga-34.jpg',
  'temporada',
  '2024-02-01'::TIMESTAMP WITH TIME ZONE,
  'Redacción TransferMad',
  ARRAY['premios-temporada-34']
),
(
  'records-goleadores-35',
  'Récords de goleadores: Los números de la Temporada 35',
  'Un análisis detallado de los máximos goleadores y los récords batidos esta temporada.',
  '
...
Estos números demuestran el nivel competitivo y espectacular de nuestra liga.
  ',
  '/news/records-goleadores.jpg',
  'records',
  '2024-06-12'::TIMESTAMP WITH TIME ZONE,
  'Departamento de Estadísticas',
  ARRAY['premios-temporada-35']
),
(
  'fichajes-verano-36',
  'Mercado de fichajes: Las operaciones del verano',
  'Todas las altas y bajas de los clubes de la Mad League durante el mercado de verano.',
  '
